...
class TestDocumentHandler(unittest.TestCase):
    ...
    def test_process_pdf_file_with_organization(self, mock_generate_filename, mock_categorize, mock_extract_text):
        ...
        mock_categorize.assert_called_once_with("Sample invoice text from TechCorp", self.categories)
    ...
    @patch('src.organizer.categorize_document')
    @patch('src.organizer.generate_ai_filename')
    def test_process_docx_file_without_organization(self, mock_generate_filename, mock_categorize, mock_extract_text):
    ...
    @patch('src.organizer.categorize_document')
    @patch('src.organizer.generate_ai_filename')
    def test_file_naming_conflict_resolution(self, mock_generate_filename, mock_categorize, mock_extract_text):
